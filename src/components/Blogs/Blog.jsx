...
function Blogs() {
  return (
    <div className="my-32 md:my-8" data-astro-cid-j7pv25f6="">
      <div className="mb-16 pb-20 lg:px-8 lg:pb-0">
        <div className="relative mx-auto max-w-5xl divide-y-2 divide-gray-200 lg:max-w-7xl">
          ...
          <div className="mt-12 grid gap-16 pt-12 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-12">
            <div className="bg-white p-5 rounded-lg grid grid-rows-1 md:grid-rows-2">
                ...
                <span className="inline-flex items-center px-3 py-0.5 rounded-lg text-sm font-medium">
                  <div className="overflow-hidden rounded-lg">
                    <img
                      ...
                      alt="Al Revolutionizes Logistics and Supply Chain Management"
              ...
              <a
                href=""
                className="py-8 md:py-4 block row-span-1"
              >
                <p className="text-4xl md:text-xl font-semibold text-gray-900">
                  Al Revolutionizes Logistics and Supply Chain Management
                </p>
                <p className="mt-3 text-2xl md:text-base text-gray-500">
                Al takes huge leaps in areas like Logistics and Supply chain management with Al Visual Inspection, Al Data Analytics, Predictive Maintenance etc.
                </p>
              </a>
              <div className="flex row-span-1 place-items-center">
                ...
                <div className="ml-3">
                  ...
                  <div className="flex space-x-1 text-lg md:text-sm text-gray-500">
                    <time date-time="2023-12-08T05:23:54.000Z">
                    December 21, 2023 
                    </time>
            ...
            <div className="bg-white p-5 rounded-lg grid grid-rows-1 md:grid-rows-2">
              ...
              >
                ...
                <p className="mt-3 text-2xl md:text-base text-gray-500">
                Google I/O 2023 envisions a future where helpful Al integrates seamlessly into our lives, breaking down barriers, empowering individuals, and tackling global challenges. By developing Al responsibly, we can shape a future where everyone benefits.
                </p>
              </a>
              <div className="flex row-span-1 place-items-center">
                <div className="flex-shrink-0">
                ...
                <div className="ml-3">
                  ...
                  <div className="flex space-x-1 text-lg md:text-sm text-gray-500">
                    <time date-time="2023-11-28T11:03:54.000Z">
                      December 8, 2023
                    </time>
                    <span aria-hidden="true">·</span>
            ...
            <div className="bg-white p-5 rounded-lg grid grid-rows-1 md:grid-rows-2">
                ...
                <span className="inline-flex items-center px-3 py-0.5 rounded-lg text-sm font-medium">
                  <div className="overflow-hidden rounded-lg">
                    <img
                      ...
                      alt="A Deep Understanding of Al Visual Inspection"
                      className="w-full h-full object-cover"
                      width="1366"
                      height="768"
                      loading="lazy"
              ...
              >
                <p className="text-4xl md:text-xl font-semibold text-gray-900">
                  A Deep Understanding of Al Visual Inspection
                </p>
                <p className="mt-3 text-2xl md:text-base text-gray-500">
                The primary objective of this blog is to offer a foundational comprehension of automated visual evaluation and elucidate how Al Visual Inspection techniques contributes to significant time and effort savings.
                </p>
              </a>
              <div className="flex row-span-1 place-items-center">
                <div className="flex-shrink-0">
                ...
                <div className="ml-3">
                  ...
                  <div className="flex space-x-1 text-lg md:text-sm text-gray-500">
                    <time date-time="2023-11-21T06:22:57.000Z">
                    November 28, 2023 
                    </time>
                    <span aria-hidden="true">·</span>
                    <span>5 min read</span>
            ...
            <div className="bg-white p-5 rounded-lg grid grid-rows-1 md:grid-rows-2">
                ...
                <span className="inline-flex items-center px-3 py-0.5 rounded-lg text-sm font-medium">
                  <div className="overflow-hidden rounded-lg">
                    <img
                      ...
                      alt="Use of Al in Process Optimization and Quality Control"
                      className="w-full h-full object-cover"
                      width="1366"
                      height="768"
                      loading="lazy"
              ...
              >
                <p className="text-4xl md:text-xl font-semibold text-gray-900">
                  Use of Al in Process Optimization and Quality Control
                </p>
                <p className="mt-3 text-2xl md:text-base text-gray-500">
                Al Visual Inspection is increasingly being used in process optimization and quality control across a range of industries, including manufacturing, healthcare, and logistics.
                </p>
              </a>
              <div className="flex row-span-1 place-items-center">
                <div className="flex-shrink-0">
