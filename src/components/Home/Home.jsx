      ...
      <div className="mt-[50vh] md:mt-[8vh]" >
        <div className="mx-10 md:mx-0">
          ...
          >
            ...
            >
              <div>
              <div className="max-w-4xl mb-32 md:mb-8" >
                <h4
                  className="text-[13rem] md:text-6xl font-albert-sans font-bold md:font-bold md:w-[28.25rem] leading-[1.2]"
              ...
              <div className="flex" data-astro-cid-ehvcvm4h="">
                ...
                <div className="flex flex-row" data-astro-cid-ehvcvm4h="">
                  ...
                  <div
                    className="hidden md:block ml-5 font-medium text-5xl md:text-base font-sans mt-4 cursor-pointer hover:text-blue-600"
              ...
              <div className="flex flex-col items-center justify-center w-full">
                <div className="border-2 shape1 border-blue-600 rounded-full overflow-hidden hidden md:block"></div>
                <div className="shape2 border-2 border-white rounded-full overflow-hidden hidden md:block"></div>
                <div className="maskContainer">
                <img src="https://www.ombrulla.com/_astro/ai-visual-inspection_banner_1.f3232628_ZyIKMH.webp" alt="Your Image" className="w-full h-auto xl:absolute xl:top-[100px] xl:left-[870px]" style={{mask: 'url("https://www.ombrulla.com/images/home/mask-banner.png") center / contain no-repeat',width: "520px",height: "520px",marginTop:'-100px' }} />                </div>
